...
//////////////////////////////////////
    ...
    $Tiempo_Avatar2="14"*Segundos;// X segundos segundo tiempo $2 
...
//-------------------------------------------------------------------------------
  ...
  bloquear("#boton3");//desbloqueo del botón
  bloquear("#boton4");//desbloqueo del botón
  bloquear("#boton5");//desbloqueo del botón
  bloquear("#boton6");//desbloqueo del botón  
     $("#nubeDer4").hide();
      allTime(); 
...
var SegundoEvento =function(){
  ...
  desbloquear("#boton5");//desbloqueo del botón
  desbloquear("#boton6");//desbloqueo del botón
