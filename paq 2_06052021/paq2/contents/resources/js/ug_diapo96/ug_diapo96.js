...
var SegundoEvento =function(){
  ...
  $(".avatar4").html(avatar($UrlAvatar4,$NombreAvatar4));
 showAvatar($NombreAvatar4);//estado del avatar
  $("#nube4").html('¿Y qué se necesita para identificar los riesgos?');
}
...
var TercerEvento =function(){
  ...
  $(".avatar2").html(avatar($UrlAvatar2,$NombreAvatar2));
 showAvatar($NombreAvatar2);//estado del avatar
  $("#nube5").html('Para cada una de las actividades del proyecto se deben analizar cuáles son las condiciones necesarias para desarrollarse y cuáles serían los eventos tanto positivos como negativos que pueden afectar su cumplimiento, para ello se utilizan listas de chequeo en donde se registra este análisis. ');
}
