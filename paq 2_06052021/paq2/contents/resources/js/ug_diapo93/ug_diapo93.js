var diapositiva=93;//diapositiva actual 
...
var SegundoEvento =function(){
  ...
  $NombreAvatar2='santiago';     
  $UrlAvatar2='_santiago8_3b.swf';
  $(".avatar2").html(avatar($UrlAvatar2,$NombreAvatar2));
  showAvatar($NombreAvatar2);//estado del avatar
  $("#nube4").html('Las medidas corresponderán al impacto que tenga el evento sobre la realización del proyecto, ya que estas pueden ser favorables o desfavorables.');
}
