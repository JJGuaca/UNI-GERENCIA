var diapositiva='81_1';//diapositiva actual 
...
var SegundoEvento =function(){
 $("#nubeIzq2").find('.j').attr("id", "nube3");
  $NombreAvatar2='santiago';     
  $UrlAvatar2='81b_1santiago.swf';
  $(".avatar2").html(avatar($UrlAvatar2,$NombreAvatar2));
 showAvatar($NombreAvatar2);//estado del avatar
  $("#nube3").html('Supongamos un proyecto base de desarrollo de software para ver una aplicación de la matriz RACI.');
