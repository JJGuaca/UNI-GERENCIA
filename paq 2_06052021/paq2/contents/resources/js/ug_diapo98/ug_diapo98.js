...
var SegundoEvento =function(){
  ...
  $(".avatar2").html(avatar($UrlAvatar2,$NombreAvatar2));
 showAvatar($NombreAvatar2);//estado del avatar
  $("#nube4").html('Consiste el valorar numéricamente el riesgo, para lo cual acudimos a técnicas de recopilación y representación de datos que incluyen modelos de simulación, aplicación de distribuciones de probabilidad y demás elementos matemáticos que nos permitan conocer el grado de impacto sobre tiempos, costos y alcances que puede tener la sucesión de un evento en particular.');
}
