...
var SegundoEvento =function(){
  ...
  $UrlAvatar3='_jimenat9.swf';
  $(".avatar4").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube3").html('Creí que esto ya estaba definido al principio del proyecto.');
...
var TercerEvento =function(){
  ...
  $UrlAvatar3='_santiagot9.swf';
  $(".avatar2").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube4").html('No necesariamente Jimena, porque durante el proceso de analizar el trabajo que se va a realizar,  puede detectarse que es más conveniente "comprar que hacer" o que obligatoriamente se deba acudir a un tercero.');
