var diapositiva=43;//diapositiva actual 
...
var SegundoEvento =function(){
  ...
  $UrlAvatar3='50b_santiago.swf';
  $(".avatar2").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube3").html('Jimena, vamos a conocer los principales problemas en el manejo del tiempo y las maneras de solucionarlos.');
