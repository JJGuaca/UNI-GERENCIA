var diapositiva="14_1";//diapositiva actual 
...
//////////////////////////////////////
    ...
    $Tiempo_Avatar3="9"*Segundos;// X segundos segundo tiempo $2 
...
var SegundoEvento =function(){
  ...
  $UrlAvatar3='14b_1javier.swf';
  $(".avatar1").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube3").html('Santiago, veamos entonces cada uno de los procesos que permitirán construir los planes secundarios de manera independiente y que consolidarán el plan de dirección del proyecto.');
window.parent.pulse();
}
