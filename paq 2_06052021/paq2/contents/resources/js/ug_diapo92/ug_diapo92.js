var diapositiva=92;//diapositiva actual 
 ...
 */
 var SegundoEvento =function(){
    ...
    // $NombreAvatar3='jimena2';     
    // $UrlAvatar3='104b_jimena.swf';
    // $(".avatar4").html(avatar2($UrlAvatar3,$NombreAvatar3));
    // showAvatar($NombreAvatar3);//estado del avatar
    // $("#nube3").html('Santiago y ¿cuáles son los objetivos de la gestión de riesgos?');
  $("#nubeIzq4").find('.j').attr("id", "nube4");
  $NombreAvatar3='santiago2';     
  $UrlAvatar3='_santiago8.swf';
  $(".avatar2").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube4").html('La respuesta a tu pregunta se desarrolla a través de este grupo compuesto por los siguientes procesos.');
}
