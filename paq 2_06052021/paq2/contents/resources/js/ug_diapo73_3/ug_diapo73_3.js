var diapositiva='73_3';//diapositiva actual 
...
/////////////////////////////// 
  ...
  $UrlAvatar3='73b_3santiago.swf';
  $(".avatar2").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube3").html('De esta manera, si mensualmente una empresa con operaciones permanentes durante todo el mes, espera disponer de sus canales por 720 horas mensuales (24 horas * 30 días), cualquier falla en el servicio que implique mas de 4 horas al mes de inactividad, será considerada como condición de afectación de la calidad.');
