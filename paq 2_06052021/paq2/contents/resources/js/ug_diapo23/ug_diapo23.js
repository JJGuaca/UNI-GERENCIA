var diapositiva=23;//diapositiva actual 
...
//////////////////////////////////////
    ...
    $Tiempo_Avatar2="22"*Segundos;// X segundos segundo tiempo $2 
...
var SegundoEvento =function(){
 ...
 $("#nubeDer4").find('.j').attr("id", "nube4");
  ...
  $UrlAvatar3='28b_jimena.swf';
  $(".avatar4").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube4").html('Santiago, ¿cuál es la diferencia entre actividades y consecución de un producto para el cumplimiento de un objetivo específico?, te lo pregunto porque muchas veces en el equipo de trabajo estamos confundidos en tareas muy largas, y no conocemos la diferencia entre desarrollar una actividad y conseguir un producto.');
