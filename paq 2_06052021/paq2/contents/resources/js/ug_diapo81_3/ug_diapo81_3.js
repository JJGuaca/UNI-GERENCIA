var diapositiva='81_3';//diapositiva actual 
...
/////////////////////////////  
  ...
  $UrlAvatar2='81b_2santiago.swf';
  $(".avatar2").html(avatar($UrlAvatar2,$NombreAvatar2));
 showAvatar($NombreAvatar2);//estado del avatar
  $("#nube3").html('Con esto se finalizaría planificar la gestión, de manera que este proceso en el procesador se visualizaría así:');
