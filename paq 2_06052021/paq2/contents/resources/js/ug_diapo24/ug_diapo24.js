 ...
 */
 var SegundoEvento =function(){
  ...
  $UrlAvatar3='29b_santiago.swf';
  $(".avatar2").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube3").html('Otra forma de ejecutar la Estructura Detallada del Trabajo puede estar centrada en el modelo de ejecución por componentes, en donde cada componente finaliza una vez se hayan completado los procesos de los negocios involucrados.  Al final cada proceso lleva consigo una o varias actividades.');
