var diapositiva=34;//diapositiva actual 
...
var SegundoEvento =function(){
  ...
  $UrlAvatar3='41b_santiago.swf';
  $(".avatar2").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube3").html('Mira Jimena, el beneficio es que nos permitirá estimar el costo y la duración de manera más precisa.');
