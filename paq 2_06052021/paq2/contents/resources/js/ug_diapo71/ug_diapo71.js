var diapositiva=71;//diapositiva actual 
...
//////////////////////////////////////
    ...
    $Tiempo_Avatar2="33"*Segundos;// X segundos segundo tiempo $2 
...
var TercerEvento =function(){
 ...
 $NombreAvatar3='jimena';     
 $UrlAvatar3='_santiago5.2.swf';
 $(".avatar2").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube5").html('A continuación se presentan los costos en el siguiente cuadro.');
