function avatar1(){
  $('#Juan200').attr('src', '../resources/html/AVATARES/10_1santiago_HTML5 Canvas.html');
}

var diapositiva='10_1';//diapositiva actual 
    var pre="PR_Mod"+fixedNumModulo+"Diapo"+diapositiva;// prefijo de variable[Mod2Diapo10]
    console.log("Carga de : [ "+pre+" ]");
//////////////////////////////////////
    $Tiempo_Avatar1="38"*Segundos;// X segundos primer tiempo $1 
