var diapositiva=21;//diapositiva actual 
...
//////////////////////////////////////
    ...
    $Tiempo_Avatar2="7"*Segundos;// X segundos segundo tiempo $2 
    $Tiempo_Avatar3="20"*Segundos;// X segundos segundo tiempo $2 
...
var SegundoEvento =function(){
  ...
  $UrlAvatar3='26b_santiago.swf';
  $(".avatar2").html(avatar($UrlAvatar3,$NombreAvatar3));
  showAvatar($NombreAvatar3);//estado del avatar
  $("#nube3").html('Jimena, puesto que, los cambios afectan a todo el equipo de trabajo y pueden tener efectos sobre los resultados se deben introducir cuidadosamente. No se puede permitir que cualquiera introduzca cambios sin autorización sino que se debe establecer desde el principio como se van adoptar, quien o quienes los aprueban, y también se va a establecer cómo se van a comunicar y a registrar.');
}
