var diapositiva=61;//diapositiva actual 
...
$UrlAvatar2='_santiago14corr.swf';
 ...
 */
 var PrimerEvento =function(){
  ...
  $NombreAvatar1='santiago';     
  $UrlAvatar1='69_santiagoBody.swf';
  $(".avatar2").html(avatar($UrlAvatar1,$NombreAvatar1));
  showAvatar($NombreAvatar1);//estado del avatar
  $("#nube3").html('Jimena, te invito para que tengas en cuenta algunos aspectos:');
